...
export SCAFFOLD_REPO=QRify-platform/portal
```
...
3. Workflow creates `QRify-platform/<name>` from `templates/{nodejs,python}`

## GitHub Actions config

**Org variables** (not secrets — ARNs/registry are not credentials):
